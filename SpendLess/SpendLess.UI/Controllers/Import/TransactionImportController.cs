...
using SpendLess.UI.Components.Import;
...
namespace SpendLess.TransactionImport.Controllers
{
        ...
        ITransactionImportService import) : SpendLessUIController
    {
        ...
        {
            return componentFactory.RenderComponentAsync<SpendLess.UI.Components.Import.TransactionImport>();
        }
        ...
        {
            var result = new SpendLess.UI.Components.Import.SetupSelectTransactionsField();
            if (selectAll)
            {
