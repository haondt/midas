...
using SpendLess.UI.Services.Admin;
using SpendLess.UI.Services.Transactions;
using SpendLess.UI.Shared.Models;

namespace SpendLess.UI.Extensions
{
    public static class ServiceCollectionExtensions
    {

        public static IServiceCollection AddSpendLessUI(this IServiceCollection services, IConfiguration configuration)
        {
