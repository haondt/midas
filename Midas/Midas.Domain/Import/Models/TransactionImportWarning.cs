...
namespace Midas.Domain.Import.Models
{
    public class TransactionImportWarning
    {
        ...
        {
            MissingSourceAccount => $"No source account was set. The default \"{MidasConstants.DefaultAccountName}\" account will be used.",
            MissingDestinationAccount => $"No source destination was set. The default \"{MidasConstants.DefaultAccountName}\" account will be used.",
            CreatingAccountWithSameNameAsExisting => "The account being created has the same name as an existing account.",
            MissingCategory => $"No category was set. The default \"{MidasConstants.DefaultCategory}\" category will be used.",
