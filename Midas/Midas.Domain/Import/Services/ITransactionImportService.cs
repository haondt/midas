...
namespace Midas.Domain.Import.Services
{
    ...
    {
        DetailedResult<DryRunResultDto, (double Progress, Optional<string> ProgressMessage)> GetDryRunResult(string jobId);
        DetailedResult<TransactionImportResultDto, (double Progress, Optional<string> ProgressMessage)> GetImportResult(string jobId);
