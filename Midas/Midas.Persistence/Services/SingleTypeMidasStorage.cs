...
{
    public class SingleTypeMidasStorage<T>(IStorage storage) : ISingleTypeMidasStorage<T> where T : notnull
    {
        private StorageKey<T> TypeForeignKey { get; } = StorageKey<SingleTypeMidasStorage<T>>.Empty.Extend<T>();
